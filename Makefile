...
DISTDIR = /home/shakir-salam/Documents/proj/emp_ms/.tmp/hello_world1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = main.cpp \
		emp_btn.cpp \
		add_emp_form.cpp moc_add_emp_form.cpp
OBJECTS       = main.o \
		emp_btn.o \
		add_emp_form.o \
		moc_add_emp_form.o
...
distdir: FORCE
	...
	$(COPY_FILE) --parents emp_btn.h add_emp_form.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp emp_btn.cpp add_emp_form.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_add_emp_form.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_add_emp_form.cpp
moc_add_emp_form.cpp: add_emp_form.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/shakir-salam/Documents/proj/emp_ms/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/shakir-salam/Documents/proj/emp_ms -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include add_emp_form.h -o moc_add_emp_form.cpp
