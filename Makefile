#############################################################################
# Makefile for building: qt_ems
# Generated by qmake (3.1) (Qt 5.15.13)
# Project:  qt_ems.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile qt_ems.pro
#############################################################################
...
INCPATH       = -I. -Iinclude -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtSql -I/usr/include/x86_64-linux-gnu/qt5/QtCore -Imoc -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = qt_ems1.0.0
DISTDIR = /home/shakir-salam/Documents/proj/e-m-s/o/qt_ems1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: qt_ems.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/database.h include/main_window.h include/emp_btn.h include/add_emp_form.h include/edit_emp_form.h include/del_emp_form.h include/employeeListDialog.h include/emp.h include/piechart.h include/login_dialog.h include/clock.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/database.cpp src/main_window.cpp src/emp_btn.cpp src/add_emp_form.cpp src/edit_emp_form.cpp src/del_emp_form.cpp src/employeeListDialog.cpp src/piechart.cpp src/login_dialog.cpp src/clock.cpp $(DISTDIR)/
...
o/main.o: main.cpp include/database.h \
		include/main_window.h \
		include/emp.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o o/main.o main.cpp

o/database.o: src/database.cpp include/database.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o o/database.o src/database.cpp
...
o/moc_main_window.o: moc/moc_main_window.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o o/moc_main_window.o moc/moc_main_window.cpp
